...
const Routers = ({ loggedIn, handleLogout, handleLogin, handleRegister, handleSearch, userId, handleLike, handleDislike }) => {
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route
                    path="/movies/:id"
                    element={<MovieDetailPage handleLike={handleLike} handleDislike={handleDislike} />}
                />
